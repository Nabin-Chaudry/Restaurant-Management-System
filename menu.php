			...
			<nav>
				<a href="index.php"><img src="images/logo.png" height="96" width="152"></a>
        			   ...
        			   <li><a href="Contact.php" onmouseover="onm.play()", onmousedown="onc.play()">Contact
         			   ...
         			   <li><a href="reservation.php" onmouseover="onm.play()", onmousedown="onc.play()">Reservation
					</a></li>
	              	...
	              	<div class="row no-gutters d-flex align-items-stretch">
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
							              ...
							              <p><span>chicken noddles</p>
							              <p><a href="payform.php" class="btn btn-primary">Order  now</a></p>
	              	...
	              	<div class="row no-gutters d-flex align-items-stretch">
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
							              ...
							              <p><span>Veg Burger</p>
							              <p><a href="payform2.php" class="btn btn-primary">Order  now</a></p>
	              	...
	              	<div class="row no-gutters d-flex align-items-stretch">
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
							              ...
							              <p><span>Sekuwa</p>
							              <p><a href="payform3.php" class="btn btn-primary">Order  now</a></p>
					        	...
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
							              ...
							              <p><span>Chicken Burger Chilly</p>
							              <p><a href="payform3.php" class="btn btn-primary">Order  now</a></p>
					        	...
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
							              ...
							              <p><span>Special Chicken Noodles</p>
							               <p><a href="payform3.php" class="btn btn-primary">Order  now</a></p>
						              </div>
					              </div>
					            </div>
	              	...
	              	<div class="row no-gutters d-flex align-items-stretch">
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
							              ...
							              <p><span>Staberry fruits Drink</p>
							             <p><a href="payform1.php" class="btn btn-primary">Order  now</a></p>
						              </div>
					              </div>
					            </div>
					        	</div>
	              	...
	              	<div class="row no-gutters d-flex align-items-stretch">
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
							              ...
							              <p><span>Staberry flavour Cake</p>
							              <p><a href="payform4.php" class="btn btn-primary">Order  now</a></p>
						              </div>
					              </div>
					            </div>
					        	</div>
					        	...
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
						              	...
						              	<div class="d-flex">
							                ...
							                <div class="one-forth">
							                  <span class="price">Rs390</span>
							                </div>
							              </div>
							              <p><span>Chockalete cake</p>
							              <p><a href="payform4.php" class="btn btn-primary">Order  now</a></p>
						              </div>
					              </div>
					            </div>
					        	...
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
						              	...
						              	<div class="d-flex">
							                ...
							                <div class="one-forth">
							                  <span class="price">Rs.549</span>
							                </div>
							              </div>
							             <p><span>Butter Ice cream</p>
							             <p><a href="payform4.php" class="btn btn-primary">Order  now</a></p>
						              </div>
					              </div>
					            </div>
					        	...
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
						              	...
						              	<div class="d-flex">
							                ...
							                <div class="one-forth">
							                  <span class="price">Rs.1029</span>
							                </div>
							              </div>
							              <p><span>Staberry Flavour Wine</p>
							              	<p><a href="payform5.php" class="btn btn-primary">Order  now</a></p>
					        	...
					        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
					              ...
					              <div class="text d-flex align-items-center">
						              	...
						              	<div class="d-flex">
							                ...
							                <div class="one-forth">
							                  <span class="price">RS.1209</span>
							                </div>
							              </div>
							              <p><span>Orange Flavour Wine</p>
							               <p><a href="payform5.php" class="btn btn-primary">Order  now</a></p>
